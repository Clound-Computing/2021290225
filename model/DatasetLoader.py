...
class DatasetLoader(Dataset):
    ...
    def news_env_init(self, tmp_data_file):
        ...
        # 这段代码加载帖子（post）和新闻文章（news）的SimCSE表示，这些表示用于计算相似性。
        ...
        # Calculation
        # 这段代码加载每个帖子的环境数据，这些数据包含了与帖子相关的新闻文章的索引和相似性分数
        ...
        # 这段代码遍历每个帖子的环境数据，计算宏观环境和微观环境的平均向量，并存储在self.MacroEnvAvg和self.MicroEnvAvg中。
        ...
        # 这段代码计算宏观环境和微观环境的相似性分数，并使用高斯核池化函数将这些相似性分数转换为核特征
