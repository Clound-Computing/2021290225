...
if __name__ == '__main__':
    ...
    datasets = []
    # 这部分代码处理训练集、验证集和测试集数据。对于每个数据集，它读取JSON文件，使用jieba分词器处理每个文本段落，并将处理后的数据添加到datasets列表。
    ...
    # 这部分代码使用CountVectorizer和TfidfTransformer计算语料库的TF-IDF权重
    # ============= Get TF-IDF =============
